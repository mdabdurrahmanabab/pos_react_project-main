        	...
        	<div className="col-md-12">
        		<div className="card">
        			<div className="card-header">
        					<CardHeader title={'Add Brand'} link={'/brand'} icon={'fa-list'} button_text={'List'}/>
        			</div>
	        						...
	        						<div className="row">
	        							<div className="col-md-6">
				        					<div className={"logo-preview mt-3"}>
				        						<img src={input.logo} className="img-thumbnail aspect-one" alt={'Logo'}/>
				        					</div>
	        							</div>
	        						</div> : null
	        					}
	        					...
	        					<div className="row justify-content-center">
	        						<div className="col-md-4">
	        							<div className="d-grid mt-4">
	        								<button className="btn theme-button" onClick={handleBrandCreate} dangerouslySetInnerHTML={{__html: isLoading ? '<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>Loading...' : "Add Brand"}}/>
	        							</div>
	        						</div>
	        					</div>
	        				</div>
